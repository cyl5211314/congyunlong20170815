...
import com.example.lenovo.congyunlong20170815.view.activity.JsonParser;
...
public class MainFragment extends BaseFragment implements View.OnClickListener {
    ...
    @Override
    View onCrearteView() {
        homeview = View.inflate(getActivity(), R.layout.mainfragment, null);
        return homeview;
    }
    ...
    private void initSpeech() {
        ...
        SpeechUtility. createUtility(getActivity(), SpeechConstant. APPID + "=599f9cf1" );
    }

    private void initView() {
        et_input = (EditText) homeview.findViewById(R.id.et_input );
        btn_startspeech = (Button)  homeview.findViewById(R.id.btn_startspeech );
        btn_startspeektext = (Button)  homeview.findViewById(R.id.btn_startspeektext);
